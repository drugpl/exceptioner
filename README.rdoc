...
Be notified about exceptions by various transports Email, Jabber, etc. Choose the option you want.
...
Exceptioner is under heavy development so better don't use it now ;)
